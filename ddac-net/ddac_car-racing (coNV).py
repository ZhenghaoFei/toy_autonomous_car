...
class ActorNetwork(object):
    ...
    def create_actor_network(self): 
        ...
        scaled_out = tf.add(tf.mul(out, self.action_bound),[0, 1, 1]) # Scale output to -action_bound to action_bound
        # non_negative_out = scaled_out
...
def train(sess, env, actor, critic):
    ...
    for i in xrange(MAX_EPISODES):
        ...
        for j in xrange(MAX_EP_STEPS):
            ...
            a = actor.predict(np.reshape(s, (-1, 31, 48, 1))) - [0,0,(1. / (1. + i + j))]
            action = a[0]
            action[1:] /=2
            action[2] = 1 - action[1]
            ...
            if r > 0:
                ...
                r = -1
            print 'r: ',r
            replay_buffer.add(np.reshape(s, (31, 48, 1)), np.reshape(a, (actor.a_dim,)), r,
                terminal, np.reshape(s2, (31, 48, 1)))
